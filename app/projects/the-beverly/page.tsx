...
<div className="grid grid-cols-3 gap-10 items-start">
  ...
  <div className="col-span-2 max-w-2xl">
    <p className="max-w-auto leading-relaxed font-medium font-inter text-[20px] px-4">
     <span className="font-bold">The Beverly Vinhomes Grand Park</span> được định vị là phân khu mang tính biểu tượng của đại đô thị, The Beverly hội tụ trọn vẹn những giá trị xứng tầm: Xa hoa – Đẳng cấp – 
     Thượng lưu.
    </p>
  </div>
...
<div className="flex flex-col gap-2">
  ...
  <div>
    ...
    <p className="text-[16px] font-inter">Key Visual,
Calendar,
Brochure,
Flyer,…</p>
  </div>
