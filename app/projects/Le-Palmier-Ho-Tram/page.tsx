...
<div className="mt-2 flex flex-col gap-3">
  ...
  {/* IMAGE (base) */}
  {/* <img
    src="/the_beverly.avif"
    alt="Lightspeed visual"
    className="w-full h-full object-cover"
  /> */}

  {/* VIDEO (overlay) */}
<div className="relative w-full h-[900px] overflow-hidden -mt-10">
  <iframe
    title="vimeo-player"
...
<div className="relative w-full h-full overflow-hidden">
  ...
  <div className="absolute inset-0 flex items-start justify-center px-6 mt-30 pt-30">
    <p className="text-gray-600 text-center text-[19px] leading-relaxed max-w-[820px] font-inter">
      ...
      đường dẫn từ cổng chính tới ngưỡng cửa, hàng cọ
    </p>
  </div>
</div>
        <img
