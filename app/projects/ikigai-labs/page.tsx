...
export default function IkigaiLabsPgae() {
...
<div className="flex items-center justify-between mb-4">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
    ...
    {/* Item 1 */}
    <Link href={"/projects/cooperative#top"} className="relative overflow-hidden h-[520px]">
      <img
                                                        onMouseEnter={() =>
  ...
  window.dispatchEvent(
    new CustomEvent("cursor-change", { detail: "default" })
        ...
        src="https://framerusercontent.com/images/DzSdeYIKRZPaP7dsYM9erT6WtKU.png?width=800&height=1200"
        className="w-full h-full object-cover transition-transform duration-500 none"
      />
