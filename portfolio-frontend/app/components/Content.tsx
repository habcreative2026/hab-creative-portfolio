...
//           <Link
//             href={"/projects"}
//             className="flex justify-end mb-10 lg:mb-20 mt-4"
//           >
...
//           className="bg-white relative mt-20 pt-20 mb-20 w-full flex items-center justify-center"
//         >
...
//             <motion.div
//               variants={number}
//               className="hidden sm:flex sm:flex-col items-end"
//             >
...
//           <Link
//             href={"/contact#top"}
//             className="flex justify-end mt-10 lg:mb-10"
//           >
//             <span className="relative cursor-pointer text-[22px] sm:text-[30px] md:text-[42px] font-bold group">
//               {t("v6")}
//               <span
...
export default function ContentPage() {
  ...
  const styleHab = useTranslationStyle("hab");
  const styleCreative = useTranslationStyle("creative");
  const styleText = useTranslationStyle("text");
  const styleV1 = useTranslationStyle("v1");
  const styleV2 = useTranslationStyle("v2");
  const styleProject = useTranslationStyle("project");
  const styleHabFooter = useTranslationStyle("hab_footer");
  const styleCreFooter = useTranslationStyle("cre_footer");
  const styleV4 = useTranslationStyle("v4");
  const styleV5 = useTranslationStyle("v5");
  const styleNumberClient = useTranslationStyle("numberclient");
  const styleV6 = useTranslationStyle("v6");
    ...
    <>
      <nav className="sticky top-0 z-0 bg-white pt-20 lg:pt-40 overflow-hidden">
        <motion.h1
          ...
          className="flex flex-wrap items-center max-w-full font-bold tracking-tight text-[60px] sm:text-[48px] md:text-[120px] lg:text-[180px] leading-none uppercase px-3 sm:px-4"
        >
          <span style={styleHab}>{t("hab")}</span>
          ...
          <span className="w-full sm:w-auto mt-2 sm:mt-0" style={styleCreative}>
            {t("creative")}
          </span>
        </motion.h1>
      </nav>
      ...
      >
        ...
        <div className="mt-4">
          <div className="flex items-end justify-between gap-4 mb-4 sm:mb-0">
            <div className="flex items-end gap-2 sm:gap-4 min-w-0">
              ...
              <span
                className="hidden sm:block text-sm text-gray-500 -mb-2"
                style={styleV1}
              >
                {t("v1")}
              </span>
            ...
            <span
              className="text-[11px] sm:text-xs font-bold whitespace-nowrap mb-2 min-[320px]:-mb-2"
              style={styleV2}
            >
              {t("v2")}
            </span>
          ...
          <div className="relative w-[96px] h-[96px]">
            ...
            <div className="relative flex items-center justify-center">
              <motion.h1
                ...
                "
              >
                <span style={styleHabFooter}>{t("hab_footer")}</span>
              </motion.h1>
              <motion.h1
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                "
              >
                <span style={styleCreFooter}>{t("cre_footer")}</span>
              </motion.h1>
            </div>
          </div>
        </motion.div>
        ...
        <section className="pt-8 mt-8">
          ...
          >
            <div>
              <p className="text-sm text-gray-400" style={styleV4}>
                {t("v4")}
              </p>
            ...
            >
              <h2
                className="text-[64px] sm:text-[100px] md:text-[160px] font-bold leading-none mt-4 sm:mt-10 pt-4 sm:pt-10"
                style={styleNumberClient}
              >
                {t("numberclient")}
              </h2>
              <span
                className="text-[28px] sm:text-[42px] md:text-[64px] text-gray-400 -mt-2 sm:-mt-6"
                style={styleV4}
              >
                {t("textnumberclient")}
              </span>
