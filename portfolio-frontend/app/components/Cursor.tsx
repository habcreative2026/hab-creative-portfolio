  ...
  return (
    <motion.div
      style={{
        ...
        zIndex: 9999,
        mixBlendMode:
          variant === "social" || variant === "image" ? "difference" : "normal",

        backgroundColor:
          variant === "social" || variant === "image" ? "#fff" : undefined,
      }}
      variants={variants}
      animate={variant}
    ...
    >
      ...
      {variant === "social" && (
        <svg width="16" height="16" viewBox="0 0 96.117 96.189" fill="none">
          <path
      ...
      {variant === "image" && (
        <svg width="50" height="50" viewBox="0 0 96.117 96.189" fill="none">
          <path
            d="M96.117 0.005 L96.112 96.189 L75.656 96.175 L75.661 34.961 L14.529 96.083 L0.063 81.617 L61.219 20.461 L0.005 20.466 L0 0 Z"
            fill="black"
          />
