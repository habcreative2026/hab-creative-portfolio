...
// import { useLanguage } from "@/app/i18n/LanguageContext";
// import FontPickerComponent from "@/app/admin/components/FontPicker";
// import FontStyleEditor, {
//   type TextStyle,
//   DEFAULT_TEXT_STYLE,
// } from "@/app/admin/components/FontStyleEditor";
// import toast from "react-hot-toast";
...
//   // ===================== 🆕 STYLE STATES =====================
//   const [styleHeaderName, setStyleHeaderName] = useState<TextStyle>({
//     ...DEFAULT_TEXT_STYLE,
//     font: "Inter",
//     size: 160,
//     weight: "700",
//     color: "#111111",
//   });
//   const [styleHeaderDescription, setStyleHeaderDescription] =
//     useState<TextStyle>({
//       ...DEFAULT_TEXT_STYLE,
//       font: "Inter",
//       size: 24,
...
//       color: "#9ca3af",
//     });
//   const [styleHeaderSubDescription, setStyleHeaderSubDescription] =
//     useState<TextStyle>({
//       ...DEFAULT_TEXT_STYLE,
//       font: "Inter",
//       size: 24,
...
//       color: "#111111",
//     });
//   const [styleHeaderYearText, setStyleHeaderYearText] = useState<TextStyle>({
//     ...DEFAULT_TEXT_STYLE,
//     font: "Inter",
//     size: 24,
//     weight: "400",
//     color: "#FFFFFF",
//   });
//   const [styleExperienceTitle, setStyleExperienceTitle] = useState<TextStyle>({
//     ...DEFAULT_TEXT_STYLE,
//     font: "Inter",
//     size: 48,
//     weight: "600",
//     color: "#111111",
//   });
//   const [styleAchievementTitle, setStyleAchievementTitle] = useState<TextStyle>(
//     {
//       ...DEFAULT_TEXT_STYLE,
//       font: "Inter",
//       size: 48,
...
//     },
//   );
//   const [styleLabelPosition, setStyleLabelPosition] = useState<TextStyle>({
//     ...DEFAULT_TEXT_STYLE,
//     font: "Inter",
//     size: 12,
//     weight: "600",
//     color: "#9ca3af",
//   });
//   const [styleLabelType, setStyleLabelType] = useState<TextStyle>({
//     ...DEFAULT_TEXT_STYLE,
//     font: "Inter",
//     size: 12,
//     weight: "600",
//     color: "#9ca3af",
//   });
//   const [styleLabelCompany, setStyleLabelCompany] = useState<TextStyle>({
//     ...DEFAULT_TEXT_STYLE,
//     font: "Inter",
//     size: 12,
//     weight: "600",
//     color: "#9ca3af",
//   });
//   const [styleLabelYear, setStyleLabelYear] = useState<TextStyle>({
//     ...DEFAULT_TEXT_STYLE,
//     font: "Inter",
//     size: 12,
//     weight: "600",
//     color: "#9ca3af",
//   });
//   const [styleLabelTitle, setStyleLabelTitle] = useState<TextStyle>({
//     ...DEFAULT_TEXT_STYLE,
//     font: "Inter",
//     size: 12,
//     weight: "600",
//     color: "#9ca3af",
//   });
//   const [styleLabelDescription, setStyleLabelDescription] = useState<TextStyle>(
//     {
//       ...DEFAULT_TEXT_STYLE,
//       font: "Inter",
//       size: 12,
...
//     },
//   );
//   const [styleLabelAchievementYear, setStyleLabelAchievementYear] =
//     useState<TextStyle>({
//       ...DEFAULT_TEXT_STYLE,
//       font: "Inter",
//       size: 12,
...
//         );
//         setHeaderSubDescription(
//           c.header_sub_description || { vi: "", en: "", de: "" },
//         );
//         setHeaderYearText(
//           c.header_year_text || { vi: "hiện tại", en: "present", de: "heute" },
//         );
...
//           c.style_header_sub_description || styleHeaderSubDescription,
//         );
//         setStyleHeaderYearText(c.style_header_year_text || styleHeaderYearText);
...
//         );
//         setStyleLabelPosition(c.style_label_position || styleLabelPosition);
//         setStyleLabelType(c.style_label_type || styleLabelType);
//         setStyleLabelCompany(c.style_label_company || styleLabelCompany);
//         setStyleLabelYear(c.style_label_year || styleLabelYear);
//         setStyleLabelTitle(c.style_label_title || styleLabelTitle);
//         setStyleLabelDescription(
//           c.style_label_description || styleLabelDescription,
//         );
//         setStyleLabelAchievementYear(
//           c.style_label_achievement_year || styleLabelAchievementYear,
//         );
//       }
//     } catch (error) {
//       console.error("Error fetching about data:", error);
...
//       setLoading(true);
//       const res = await fetch(
//         `${process.env.NEXT_PUBLIC_API_URL}/api/about/upload-image`,
//         {
//           method: "POST",
//           body: formData,
//         },
...
//         style_header_description: styleHeaderDescription,
//         style_header_sub_description: styleHeaderSubDescription,
//         style_header_year_text: styleHeaderYearText,
//         style_experience_title: styleExperienceTitle,
//         style_achievement_title: styleAchievementTitle,
//         style_label_position: styleLabelPosition,
//         style_label_type: styleLabelType,
//         style_label_company: styleLabelCompany,
//         style_label_year: styleLabelYear,
//         style_label_title: styleLabelTitle,
//         style_label_description: styleLabelDescription,
//         style_label_achievement_year: styleLabelAchievementYear,
...
//     <div className="bg-[#0B0F19] text-[#E2E8F0] scroll-none max-h-[100vh] overflow-auto">
//       {/* Header Image */}
//       <div className="bg-[#131A2C] border border-slate-800 rounded-xl p-4 mb-4 sticky top-0 z-20">
//         <h3 className="font-semibold text-purple-400 text-xs uppercase tracking-wider mb-3">
//           Header Image
//         </h3>
//         <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
...
//               <FontStyleEditor
//                 label="Năm"
//                 value={styleHeaderYearText}
//                 onChange={setStyleHeaderYearText}
//                 showLetterSpacing
//                 defaultColor="#FFFFFF"
//               />
//             </div>
...
//                       setLabelPosition,
//                     )}
//                     {renderMultiLangInput("Loại hình", labelType, setLabelType)}
//                     {renderMultiLangInput(
//                       "Công ty",
//                       labelCompany,
//                       setLabelCompany,
//                     )}
//                     {renderMultiLangInput("Thời gian", labelYear, setLabelYear)}
//                   </div>
//                 </div>

//                 {/* 🆕 Label Styles */}
//                 <div className="bg-[#1F2937]/20 p-3 rounded-lg border border-slate-700/50 mb-3 space-y-2">
//                   <p className="text-[10px] text-slate-400 font-medium">
//                     Style cho Labels
//                   </p>
//                   <FontStyleEditor
//                     label="Label Vị trí"
//                     value={styleLabelPosition}
//                     onChange={setStyleLabelPosition}
//                     defaultColor="#9ca3af"
//                   />
//                   <FontStyleEditor
//                     label="Label Loại hình"
//                     value={styleLabelType}
//                     onChange={setStyleLabelType}
//                     defaultColor="#9ca3af"
//                   />
//                   <FontStyleEditor
//                     label="Label Công ty"
//                     value={styleLabelCompany}
//                     onChange={setStyleLabelCompany}
//                     defaultColor="#9ca3af"
//                   />
//                   <FontStyleEditor
//                     label="Label Thời gian"
//                     value={styleLabelYear}
//                     onChange={setStyleLabelYear}
//                     defaultColor="#9ca3af"
//                   />
//                 </div>
...
//                   <FontStyleEditor
//                     label="Style Tiêu đề Kinh nghiệm"
...
//                   </p>
//                   <div className="grid grid-cols-2 gap-2">
//                     {renderMultiLangInput("Tiêu đề", labelTitle, setLabelTitle)}
//                     {renderMultiLangInput(
//                       "Mô tả",
//                       labelDescription,
//                       setLabelDescription,
...
//                   <FontStyleEditor
//                     label="Label Tiêu đề"
//                     value={styleLabelTitle}
//                     onChange={setStyleLabelTitle}
//                     defaultColor="#9ca3af"
//                   />
//                   <FontStyleEditor
//                     label="Label Mô tả"
//                     value={styleLabelDescription}
//                     onChange={setStyleLabelDescription}
//                     defaultColor="#9ca3af"
//                   />
//                   <FontStyleEditor
//                     label="Label Thời gian"
//                     value={styleLabelAchievementYear}
//                     onChange={setStyleLabelAchievementYear}
//                     defaultColor="#9ca3af"
//                   />
//                 </div>
