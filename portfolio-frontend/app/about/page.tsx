...
//   // 🆕 All styles
//   style_header_name?: TextStyle;
//   style_header_description?: TextStyle;
//   style_header_sub_description?: TextStyle;
//   style_header_year_text?: TextStyle;
//   style_experience_title?: TextStyle;
//   style_achievement_title?: TextStyle;
//   style_label_position?: TextStyle;
//   style_label_type?: TextStyle;
//   style_label_company?: TextStyle;
//   style_label_year?: TextStyle;
//   style_label_title?: TextStyle;
//   style_label_description?: TextStyle;
//   style_label_achievement_year?: TextStyle;
...
//   if (style.letterSpacing) css.letterSpacing = `${style.letterSpacing}em`;
...
//             >
//               <div className="flex items-center flex-wrap">
//                 <span style={applyStyle(aboutData?.style_header_name)}>
//                   {getText(aboutData?.header_name) || "QUI BUI"}
//                 </span>
//               </div>
//             </motion.h1>
...
//               <p
//                 style={applyStyle(
//                   aboutData?.style_header_description,
//                   "#9ca3af",
//                 )}
//               >
//                 {getText(aboutData?.header_description) || "Về tôi"}
...
//               <p
//                 className="leading-relaxed mt-2 md:-mt-4"
//                 style={{
//                   textIndent: isDesktop ? "100px" : "0px",
//                   ...applyStyle(aboutData?.style_header_sub_description),
//                 }}
//               >
//                 {getText(aboutData?.header_sub_description) ||
//                   "Tôi là một nhà thiết kế và phát triển web sáng tạo..."}
...
//             <motion.div
//               style={{ y: textY }}
//               className="absolute bottom-4 right-8 md:right-4 z-30 mix-blend-difference whitespace-nowrap"
//             >
//               <span
//                 style={applyStyle(aboutData?.style_header_year_text, "#FFFFFF")}
//               >
//                 {getText(aboutData?.header_year_text) || ""}
//               </span>
//             </motion.div>
...
//           <div className="grid grid-cols-1 md:grid-cols-[40%_20%_20%_20%] mb-6 md:mb-2">
//             <h2
//               className="md:col-start-2 mb-6 md:mb-14"
//               style={applyStyle(aboutData?.style_experience_title)}
//             >
//               {getText(aboutData?.experience_title) || "Kinh nghiệm làm việc"}
//             </h2>
//           </div>

//           <div className="hidden md:grid grid-cols-[40%_20%_20%_20%] mb-2">
//             <div style={applyStyle(aboutData?.style_label_position, "#9ca3af")}>
//               {getText(labels.position)}
//             </div>
//             <div style={applyStyle(aboutData?.style_label_type, "#9ca3af")}>
//               {getText(labels.type)}
//             </div>
//             <div style={applyStyle(aboutData?.style_label_company, "#9ca3af")}>
//               {getText(labels.company)}
//             </div>
//             <div style={applyStyle(aboutData?.style_label_year, "#9ca3af")}>
//               {getText(labels.year)}
//             </div>
//           </div>
...
//             style={applyStyle(aboutData?.style_achievement_title)}
//           >
//             {getText(aboutData?.achievement_title) || "Thành tựu"}
//           </h2>

//           <div className="hidden md:grid grid-cols-[30%_50%_10%] mb-2">
//             <div style={applyStyle(aboutData?.style_label_title, "#9ca3af")}>
//               {getText(labels.title)}
//             </div>
//             <div
//               style={applyStyle(aboutData?.style_label_description, "#9ca3af")}
//             >
//               {getText(labels.description)}
//             </div>
//             <div
//               style={applyStyle(
//                 aboutData?.style_label_achievement_year,
//                 "#9ca3af",
//               )}
//             >
//               {getText(labels.achievementYear)}
//             </div>
//           </div>
