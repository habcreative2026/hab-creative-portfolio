...
interface AboutData {
  ...
  style_experience_position?: {
    font: string;
    size: number;
    weight: string;
    color: string;
  };
  style_experience_type?: {
    font: string;
    size: number;
    weight: string;
    color: string;
  };
  style_experience_company?: {
    font: string;
    size: number;
    weight: string;
    color: string;
  };
  style_experience_year?: {
    font: string;
    size: number;
    weight: string;
    color: string;
  };
  style_achievement_item_title?: {
    font: string;
    size: number;
    weight: string;
    color: string;
  };
  style_achievement_description?: {
    font: string;
    size: number;
    weight: string;
    color: string;
  };
  style_achievement_year?: {
    font: string;
    size: number;
    weight: string;
    color: string;
...
export default function AboutPage() {
  ...
  // Helper: tạo style object từ field style
  const styleOf = (
    s: any,
    fallbackSize = 24,
    fallbackWeight = "600",
    ...
    fontSize: s?.size ? `${s.size}px` : `${fallbackSize}px`,
    fontWeight: s?.weight || fallbackWeight,
      ...
      <div className="px-4 pt-2 mt-2 lg:-pt-24 lg:-mt-24">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-[40%_20%_20%_20%] mb-6 md:mb-2">
            <h2
              className="md:col-start-2 text-3xl md:text-5xl font-semibold mb-6 md:mb-14"
              style={styleOf(
                aboutData?.style_experience_title,
                48,
                "600",
                "#111111",
              )}
          ...
          <div className="hidden md:grid grid-cols-[40%_20%_20%_20%] text-xs font-semibold text-gray-400 mb-2">
            <div style={styleOf(aboutData?.style_label, 12, "600", "#9ca3af")}>
          ...
          <div className="space-y-4 text-[18px] md:text-[24px] font-semibold">
            {experiences.map((exp, index) => (
              ...
              >
                <div
                  style={styleOf(
                    aboutData?.style_experience_position,
                    24,
                    "600",
                    "#111111",
                  )}
                ...
                <div
                  ...
                  style={styleOf(
                    aboutData?.style_experience_type,
                    24,
                    "600",
                    "#111111",
                  )}
                ...
                <div
                  className="text-sm md:text-[24px]"
                  style={styleOf(
                    aboutData?.style_experience_company,
                    24,
                    "600",
                    "#111111",
                  )}
                ...
                <div
                  className="text-sm md:text-[24px]"
                  style={styleOf(
                    aboutData?.style_experience_year,
                    24,
                    "600",
                    "#111111",
                  )}
        ...
        >
          <h2
            className="text-3xl md:text-5xl mb-10 md:mb-14 font-semibold"
            style={styleOf(
              aboutData?.style_achievement_title,
              48,
              "600",
              "#111111",
            )}
          ...
          <div className="space-y-4 text-[18px] md:text-[24px] font-semibold mb-20">
            {achievements.map((ach, index) => (
              ...
              >
                <div
                  style={styleOf(
                    aboutData?.style_achievement_item_title,
                    24,
                    "600",
                    "#111111",
                  )}
                ...
                <div
                  className="text-sm md:text-[24px]"
                  style={styleOf(
                    aboutData?.style_achievement_description,
                    24,
                    "600",
                    "#111111",
                  )}
                ...
                <div
                  className="text-sm md:text-[24px]"
                  style={styleOf(
                    aboutData?.style_achievement_year,
                    24,
                    "600",
                    "#111111",
                  )}
